...
import com.github.onsdigital.cli.builder.DataSetHeaderOnlyBuilder;
...
@Parameters(commandNames = CsvHeadersCommand.ACTION,
            commandDescription = "Convert CSV File to Json String")
public class CsvHeadersCommand extends AbstractCommand implements Command {
    public static final String ACTION = "convertCSVToHeaders";
    public static final String UTF_8 = "UTF-8";
    private static final Logger LOGGER = LoggerFactory.getLogger(CsvHeadersCommand.class);
    ...
    public void execute() throws IOException {
        ...
        buildFile(new DataSetHeaderOnlyBuilder(file).build());
    }
