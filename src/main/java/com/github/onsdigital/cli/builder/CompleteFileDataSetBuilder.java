 ...
 */
public class CompleteFileDataSetBuilder extends AbstractDataSetBuilder<Map> {
  private static final Logger LOGGER = LoggerFactory.getLogger(CompleteFileDataSetBuilder.class);

  public CompleteFileDataSetBuilder(final File dataDirectory) {
    super(dataDirectory);
